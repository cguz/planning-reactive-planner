...
(:init
		...
		(not (Hasimage sheet4 back image-1))
		(not (Hasimage sheet4 front image-1))
		(not (Hasimage sheet4 back image-2))
		(not (Hasimage sheet4 front image-2))
		(not (Hasimage sheet4 back image-3))
		(not (Hasimage sheet4 front image-3))
		(not (Hasimage sheet4 back image-4))
		(not (Hasimage sheet4 front image-4))
		(not (Hasimage sheet4 back image-5))
		(not (Hasimage sheet4 front image-5))
		(not (Hasimage sheet4 Front image-6))
		(not (Hasimage sheet4 Back image-6))
		(not (Hasimage sheet4 back image-7))
		(not (Hasimage sheet4 front image-7))

		(not (Printedwith sheet1 Front Color))
		(not (Printedwith sheet2 Front Color))
		(not (Printedwith sheet3 Front Color))
		(not (Printedwith sheet4 Front Color))
		(not (Printedwith sheet1 Front Black))
		(not (Printedwith sheet2 Front Black))
		(not (Printedwith sheet3 Front Black))
		(not (Printedwith sheet4 Front Black))
		(not (Printedwith sheet1 Back Black))
		(not (Printedwith sheet2 Back Black))
		(not (Printedwith sheet3 Back Black))
		(not (Printedwith sheet4 Back Black))
		(not (Printedwith sheet1 Back Color))
		(not (Printedwith sheet2 Back Color))
		(not (Printedwith sheet3 Back Color))
		(not (Printedwith sheet4 Back Color))
)
(:global-goal (and
		(Hasimage sheet1 Front image-1)
		(Hasimage sheet1 Front image-6)
		(Hasimage sheet1 Back image-2)
		(Hasimage sheet2 Front image-2)
		(Hasimage sheet2 Front image-7)
		(Hasimage sheet2 Back image-3)
		(Hasimage sheet3 Front image-4)
		(Hasimage sheet3 Front image-6)
		(Hasimage sheet3 Back image-1)
		(Hasimage sheet4 Front image-1)
		(Hasimage sheet4 Front image-7)
		(Hasimage sheet4 Back image-3)
