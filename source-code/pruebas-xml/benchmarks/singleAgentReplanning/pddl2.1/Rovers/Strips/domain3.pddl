...
(:predicates (at ?x - rover ?y - waypoint) 
	     ...
	     (more_soils ?w - waypoint)
  	     (more_rocks ?w - waypoint)
...
:precondition (and (empty ?s) (at ?x ?p) (at_soil_sample ?p) (equipped_for_soil_analysis ?x) (store_of ?s ?x) 
		)
...
(:action sample_rock
:parameters (?x - rover ?s - store ?p - waypoint)
:precondition (and (empty ?s) (at ?x ?p) (at_rock_sample ?p) (equipped_for_rock_analysis ?x) (store_of ?s ?x)
		)
