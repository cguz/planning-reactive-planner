...
set style line 6 lt 3 lc 17 pt 6
plot '$FILE1' u 2:5 title "real time - $TITLE1" w lp ls 1 ,\
'$FILE1' u 2:3 title "estimated time - $TITLE1" w lp ls 3 ,\
'$FILE1' u 2:6 title "time to find a plan - $TITLE1" w lp ls 5 ,\
'$FILE2' u 2:5 title "real time - $TITLE2" w lp ls 2 ,\
'$FILE2' u 2:3 title "estimated time - $TITLE2" w lp ls 4 ,\
'$FILE2' u 2:6 title "time to find a plan - $TITLE2" w lp ls 6 

#plot '$FILE1' u 2:5 title "real time to generate the tree T - $TITLE1" w lp ls 1 ,\
#'$FILE1' u 2:3 title "estimated time to generate the tree T - $TITLE1" w lp ls 3 ,\
#'$FILE1' u 2:6 title "time to find a plan - $TITLE1" w lp ls 5 ,\
#'$FILE2' u 2:5 title "real time to generate the tree T - $TITLE2" w lp ls 2 ,\
#'$FILE2' u 2:3 title "estimated time to generate the tree T - $TITLE2" w lp ls 4 ,\
#'$FILE2' u 2:6 title "time to find a plan - $TITLE2" w lp ls 6 
